...
- (void)realtimeSearch:(NSString *)string
{
    ...
    //开启新线程
    self.searchThread = [[NSThread alloc]
                         initWithTarget:self
                         selector:@selector(searchBegin:)
                         object:string];
                  ...
                  fromString:(NSString *)fromString
{
    ...
    NSUInteger location = [[fromString lowercaseString]
                           rangeOfString:[searchString lowercaseString]].location;
